...
<body>
    ...
    <div class="pages page-work" id="page-work">
        <div class="container">
            ...
            <header>
                ...
                <div class="row">
                    <div class="offset2 col-sm-8 col-lg-8">
                        <p>
    ...
    <div class="pages page-clients" id="page-clients">
        <div class="container">
            ...
            <!-- Client logos -->
            <div class="row">
                <div class="center col-sm-2 col-lg-2">
            ...
            <div class="row">
                <div class="offset2 center smallFontBy08 col-sm-8 col-lg-8">
                    <p>
    ...
    <div class="pages white paralax page-features" id="page-features">
        ...
        <div class="container">
            ...
            <article>
                <!-- Features blocks -->
                <div class="row">
                    <div class="center col-sm-4 col-lg-4">
        ...
        <div class="container">
            ...
            <article>
                <div class="row">
                    ...
                    <!-- End Contact form -->
                    <!-- Contact information -->
                    <div class="offset1 col-sm-5 col-lg-5">
                        <h5>Meet Us</h5>
                        <div class="media">
